...
export const metadata: Metadata = {
	title: "Terms of Service - Kurvo",
	description:
		"Kurvo's Terms of Service. Fair, transparent terms for our free and open-source video editor.",
	openGraph: {
		title: "Terms of Service - Kurvo",
		description:
			"Kurvo's Terms of Service. Fair, transparent terms for our free and open-source video editor.",
	...
	return (
		...
		>
				...
				>
					...
					<AccordionContent>
						...
						<ol className="list-decimal space-y-2 pl-6">
							...
							<li>Don't use Kurvo for illegal activities or harassment</li>
							<li>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					<strong>You own everything you create.</strong> Kurvo processes
					...
					projects, or any content you create using Kurvo.
				</p>
				<ul className="list-disc space-y-2 pl-6">
					...
					<li>No watermarks, no licensing restrictions from Kurvo</li>
				</ul>
			</section>

			<section className="flex flex-col gap-3">
				<h2 className="text-2xl font-semibold">How You Can Use Kurvo</h2>
				<p>Kurvo is free for personal and commercial use. You can:</p>
				<ul className="list-disc space-y-2 pl-6">
					<li>
						Create videos for personal, educational, or commercial purposes
					</li>
					<li>Use Kurvo for client work and paid projects</li>
					<li>Share and distribute videos created with Kurvo</li>
					<li>
						Modify and distribute the Kurvo software (under MIT license)
					</li>
				</ul>
				<p>
					<strong>What we ask:</strong> Don't use Kurvo for illegal
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					Kurvo offers optional AI-powered features that require server
					processing:
				</p>
				<ul className="list-disc space-y-2 pl-6">
					<li>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					Kurvo is provided "as is" without warranties. While we strive for
			...
			<section className="flex flex-col gap-3">
				...
				<p>Because Kurvo is open source, you have additional rights:</p>
				<ul className="list-disc space-y-2 pl-6">
					<li>Review our code to see exactly how we handle your data</li>
					<li>Self-host Kurvo on your own servers</li>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					When using Kurvo, make sure you have the right to use any content
					you import:
				</p>
				<ul className="list-disc space-y-2 pl-6">
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					Kurvo is provided free of charge. To the extent permitted by law:
				</p>
				<ul className="list-disc space-y-2 pl-6">
			...
			<section className="flex flex-col gap-3">
				...
				<p>We may update Kurvo and these terms:</p>
				<ul className="list-disc space-y-2 pl-6">

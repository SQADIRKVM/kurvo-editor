...
export const metadata: Metadata = {
	title: "Contributors - Kurvo",
	description:
		"Meet the amazing people who contribute to Kurvo, the free and open-source video editor.",
	openGraph: {
		title: "Contributors - Kurvo",
		description:
			"Meet the amazing people who contribute to Kurvo, the free and open-source video editor.",
...
async function getContributors(): Promise<Contributor[]> {
	try {
		const response = await fetch(
			"https://api.github.com/repos/Kurvo-app/Kurvo/contributors?per_page=100",
			{
				headers: {
					Accept: "application/vnd.github.v3+json",
					"User-Agent": "Kurvo-Web-App",
				},
...
export default async function ContributorsPage() {
	...
	return (
		<BasePage
			title="Contributors"
			description="Meet the amazing people who contribute to Kurvo, the free and open-source video editor."
		>
			...
			<div className="mx-auto flex max-w-6xl flex-col gap-20">
				...
				<GitHubContributeSection
					...
					description="Kurvo is built by developers like you. Every contribution, no matter how small, helps make video editing more accessible for everyone."
				/>
			</div>
		</BasePage>
	);
	...
	return (
		<div className="flex flex-col gap-12">
			<div className="flex flex-col gap-2 text-center">
				...
				<p className="text-muted-foreground">
					Everyone who makes Kurvo better
				</p>
			</div>
	...
	return (
		<div className="flex flex-col gap-10">
			<div className="flex flex-col gap-2 text-center">
				...
				<p className="text-muted-foreground">Tools we use to build Kurvo</p>
			</div>

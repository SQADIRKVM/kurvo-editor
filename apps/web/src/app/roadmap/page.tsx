...
const roadmapItems: RoadmapItem[] = [
	...
	},
	{
		...
		description:
			"Native Kurvo apps for Mac, Windows, Linux, and iOS/Android.",
		status: {
			text: "Not started",
			type: "default",
		},
...
export const metadata: Metadata = {
	title: "Roadmap - Kurvo",
	description:
		"See what's coming next for Kurvo - the free, open-source video editor that respects your privacy.",
	openGraph: {
		title: "Kurvo Roadmap - What's Coming Next",
		description:
			"See what's coming next for Kurvo - the free, open-source video editor that respects your privacy.",
		type: "website",
		images: [
...
export default function RoadmapPage() {
	return (
		<BasePage
			title="Roadmap"
			description={`What's coming next for Kurvo (last updated: ${LAST_UPDATED})`}
		>
			<div className="mx-auto flex max-w-4xl flex-col gap-16">
				...
				<GitHubContributeSection
					title="Want to help?"
					description="Kurvo is open source and built by the community. Every contribution,

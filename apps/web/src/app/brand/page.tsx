...
const ASSET_SECTIONS: AssetSection[] = [
	{
		title: "Symbol",
		description:
			"Use the symbol on its own when the Kurvo name is already present nearby or space is limited.",
		cols: "2",
		assets: [
			{
				src: "/logos/kurvo/symbol.svg",
				theme: "dark",
				label: "Symbol",
				width: 400,
				height: 400,
			...
			{
				src: "/logos/kurvo/symbol-light.svg",
				theme: "light",
				label: "Symbol",
				width: 400,
				height: 400,
	...
	},
	{
		...
		assets: [
			...
			{
				src: "/logos/kurvo/logo-light.svg",
				theme: "light",
				label: "Logo",
				width: 1809,
				height: 400,
			...
			{
				src: "/logos/kurvo/text-light.svg",
				theme: "light",
				label: "Text",
				width: 1760,
				height: 400,
...
export default function BrandPage() {
	return (
		<BasePage
			...
			description={
				<>
					Download Kurvo brand assets for use in your projects.{" "}
					<Link
						href="#guidelines"
			...
			<div id="guidelines" className="flex flex-col gap-8 text-sm">
				<div className="flex flex-col gap-3">
					...
					<p className="text-muted-foreground text-base leading-relaxed">
						Kurvo is open source — the code is free to use under its license.
						That license does not cover the name or logo. You can say you use
						Kurvo, that your project integrates with Kurvo, or that it was
						built on top of Kurvo. You cannot name your product Kurvo, imply
						we made or endorse your product, or use the marks commercially
						without asking first. For anything unclear, reach out at{" "}
						<Link
							href="mailto:brand@kurvo.app"
							className="underline underline-offset-4"
						>
							brand@kurvo.app
						</Link>
				...
				<div className="flex flex-col gap-3">
					...
					<ul className="text-muted-foreground text-base flex flex-col gap-2 leading-relaxed">
						{[
							"Using Kurvo in the name of your product, service, or domain.",
							"Implying that Kurvo made, sponsors, or endorses your work.",

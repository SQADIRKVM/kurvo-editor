...
export const metadata: Metadata = {
	title: "Sponsors - Kurvo",
	description:
		"Support Kurvo and help us build the future of free and open-source video editing.",
	openGraph: {
		title: "Sponsors - Kurvo",
		description:
			"Support Kurvo and help us build the future of free and open-source video editing.",
		...
		<BasePage>
			<div className="flex flex-col gap-8 text-center">
				...
				<p className="text-muted-foreground mx-auto max-w-2xl text-xl leading-relaxed text-pretty">
					Support Kurvo and help us build the future of privacy-first video
					editing.
				</p>
			</div>
			<SponsorsGrid />
